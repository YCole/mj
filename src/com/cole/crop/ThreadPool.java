...
public class ThreadPool {
    ...
    private static final int KEEP_ALIVE_TIME = 5; // 5 seconds
    ...
    ResourceCounter mCpuCounter = new ResourceCounter(8);
    ResourceCounter mNetworkCounter = new ResourceCounter(8);
    ...
    private   class Worker<T> implements Runnable, Future<T>, JobContext {
        ...
        public void run() {
            ...
            if (mListener != null) mListener.onFutureDone((cole.crop.Future<T>) this);
        }
