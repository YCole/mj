...
public class ExifTag {
    ...
    private final int MAX_COMPCOUNT = 1024*1024;
    ...
    public int getComponentCount() {
        if(mComponentCountActual > MAX_COMPCOUNT ){
            return MAX_COMPCOUNT;
        }
     ...
     */
    @SuppressLint("NewApi")
    public Rational getValueAsRational(int defaultValue) {
