...
public abstract class MediaItem extends MediaObject {
    ...
    public static final int TYPE_FULLIMAGE = 3;
    ...
    private static int sMicrothumbnailTargetSize = 100;
    ...
    //sign for if the image is rotated
    ...
    public abstract ThreadPool.Job<Bitmap> requestFaceImage(int index);
    ...
    public void setGroupIdList(ArrayList<MediaItem> items) {
    ...
    public String[] getTags(
            HashMap<Integer, HashMap<String, ArrayList<String>>> allTags) {
        return null;
    }
    ...
    public ArrayList<Rect> getFaceRects() {
        return null;
    }
   ...
   /* public int getEncrypt() {
    ...
    public ArrayList<MediaItem> getGroupIdItems() {
    ...
    public void copyOrMoveTo(String destCopyOrMovePath, boolean isMove) {

    }

    //add by yujun for rename
    public void copyOrMoveTo(String destCopyOrMovePath, boolean isMove, boolean isRename) {
    ...
    public ThreadPool.Job<FullImageDecoder> requestFullScreenImage() {
        return null;
    }
    ...
    //add by yujun for bug:617003196904
    public boolean checkRightsStatus(){
    	return false;
    }
	...
	public String getCameraType() {
        return " ";//jacksun modify for Exception isBokenFile error-->
    }

	//zhaosuzhou add for encryption or decryption start{
  	@Override
  	public boolean isNeedShowLockIcon() {
  		return UserManagerUtil.isNormalMode() /*&& EncryptionManager.isNeedShowLockIcon(getPath(),getFilePath())*/;
  	}
  	@Override
    ...
    public void copyOrMoveSingleTo(String destCopyOrMovePath, boolean isMove,boolean isRename,
            ThreadPool.JobContext jc) {
    }

    public void updateFilePathFromCursor(){
    }
}
