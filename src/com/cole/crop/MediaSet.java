...
public abstract class MediaSet extends MediaObject {
    ...
    public ArrayList<MediaItem> getMediaItem(String name) {
        return new ArrayList<MediaItem>();
    }

    public ArrayList<MediaItem> getMediaItem(String name, int start, int count) {
        return new ArrayList<MediaItem>();
    }

    public ArrayList<MediaItemGroup> getMediaItemGroups(String name) {
        return null;
    }

    public void subGroupUpdate() {
    ...
    public static int getCoverItemsCount(boolean puzzleMode) {
        int itemCount = 1;
        if (puzzleMode) {
            itemCount = PUZZLE_COUNT;
        }
    ...
    public long reload(EnumerateListener l) {
        return reload();
    }
    ...
    public ArrayList<Path> getSimilarData(int type, String key) {
        return null;
    }

    public void RegisterSimilarPath(Path path) {

    }

    // For MTK Cluster Solution
    // / M: while reload in ClusterAlbum ,should assign this object to
    // ClusterAlbumSet.
    public MediaSet mCurrentClusterAlbum;
    // / M: We think recursive calls in ClusterAlbum and ClusterAlbumSet as a
    // Stack , and record offset to the Stack top.
    ...
    public ArrayList<MediaItem> getMediaItem(int type) {
        return new ArrayList<MediaItem>();
    }

    public boolean findIndexOfDeleteList(Path path) {
        return false;
    }


    static final int GET_COUNT = 1;
    static final int GET_GROUP = 2;
    static final int GET_ITEM = 3;
    static final int GET_TYPE_ITEM = 4;

    public boolean needReload(int getType) {
        return true;
    }
