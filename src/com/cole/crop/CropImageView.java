...
/*
 * this is CIRCLE style crop image view
 * 
 * 
 */
...
public class CropImageView extends ImageView {
	...
	private int mDefaultStyleIndex = 1;

	private Style mStyle = styles[1];
	...
	public CropImageView(Context context, AttributeSet attrs, int defStyle) {
		...
		mBorderWidth = a.getDimensionPixelSize(R.styleable.CropImageView_cropBorderWidth, android.R.color.transparent);
	...
	public void saveBitmapToFile(File folder, int expectWidth, int exceptHeight, boolean isSaveRectangle) {
		...
		File saveFile = createFile(folder, "-cropped", ".jpg");
		if (mStyle == Style.CIRCLE && !isSaveRectangle) {
