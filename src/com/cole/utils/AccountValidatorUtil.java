...
public class AccountValidatorUtil {
     ...
     * 正则表达式：验证用户名
     */
    public static final String REGEX_USERNAME = "^[a-zA-Z]\\w{8,20}$";
    /**
     * 正则表达式：验证6位数字的验证码
     */
    public static final String REGEX_CODE_NUMBER = "[\\d]{6}";
     ...
     * @return 校验通过返回true，否则返回false
     */
    public static boolean isCodenumber(String codenumber) {
        return Pattern.matches(REGEX_CODE_NUMBER, codenumber);
    }
