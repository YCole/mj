...
public final class LinphoneUtils {
    ...
    public static void initLoggingService(boolean isDebugEnabled, String appName) {
        if (!com.gome.beautymirror.LinphonePreferences.instance().useJavaLogger()) {
    ...
    public static boolean isNumberAddress(String numberOrAddress) {
        ProxyConfig proxy = com.gome.beautymirror.LinphoneManager.getLc().createProxyConfig();
    ...
    public static boolean onKeyVolumeAdjust(int keyCode) {
        ...
        if (!com.gome.beautymirror.LinphoneService.isReady()) {
            Log.i("Couldn't change softvolume has service is not running");
            return true;
        } else if (keyCode == KeyEvent.KEYCODE_VOLUME_UP) {
            com.gome.beautymirror.LinphoneManager.getInstance().adjustVolume(1);
    ...
    public static void setBgPictureFromUri(Context c, RelativeLayout layout, Uri pictureUri, Uri thumbnailUri) {
        if (pictureUri == null && thumbnailUri == null) {
            Bitmap bm = ContactsManager.getInstance().getDefaultAvatarBitmap();
            bm = BlurUtils.blurBitmap(getContext(), bm, 3f);
        ...
        if (pictureUri.getScheme().startsWith("http")) {
            ...
            if (bm == null) {
                bm = BitmapFactory.decodeResource(getContext().getResources(),R.drawable.call_default_bg );
            }
            bm = BlurUtils.blurBitmap(getContext(), bm, 3f);
            layout.setBackgroundDrawable(new BitmapDrawable(bm));
        } else {
    ...
    public static String getDisplayableUsernameFromAddress(String sipAddress) {
        ...
        Core lc = com.gome.beautymirror.LinphoneManager.getLcIfManagerNotDestroyedOrNull();
        ...
        if (username.contains("@")) {
            ...
            if (lpc != null) {
                ...
                if (domain.equals(com.gome.beautymirror.LinphoneManager.getInstance().getContext().getString(R.string.default_domain))) {
                    return username.split("@")[0];
                }
            }
        }
    ...
    public static String getFullAddressFromUsername(String username) {
        ...
        if (!sipAddress.contains("@")) {
            ...
            if (lpc != null) {
                ...
                sipAddress = sipAddress + "@" + com.gome.beautymirror.LinphoneManager.getInstance().getContext().getString(R.string.default_domain);
            }
        }
        return sipAddress;
    }
    ...
    private static Context getContext() {
        if (context == null && com.gome.beautymirror.LinphoneManager.isInstanciated())
            context = com.gome.beautymirror.LinphoneManager.getInstance().getContext();
        return context;
    }
    ...
    public static Uri getCVSPathFromLookupUri(String content) {
        ...
        FriendList[] friendList = com.gome.beautymirror.LinphoneManager.getLc().getFriendsLists();
    ...
    public static void setInitiateVideoCall(boolean initiate) {
    ...
    private static Core getLc() {
        if (!com.gome.beautymirror.LinphoneManager.isInstanciated())
            return null;
        return com.gome.beautymirror.LinphoneManager.getLcIfManagerNotDestroyedOrNull();
    }
