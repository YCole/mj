...
import com.gome.beautymirror.ui.LinphoneOverlay;
    ...
    */
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        ...
        if (com.gome.beautymirror.LinphoneManager.isInstanciated()) {
            ...
            com.gome.beautymirror.LinphoneManager.createAndStart(LinphoneService.this);
        }
...
//              }
    ...
    public void onCreate() {
        ...
        // In case restart after a crash. Main in BeautyMirrorActivity
    ...
    public void displayGroupChatMessageNotification(String subject, String conferenceAddress, String fromName, Uri fromPictureUri, String message) {
        Intent notifIntent = new Intent(this, BeautyMirrorActivity.class);
    ...
    private Class<? extends Activity> incomingReceivedActivity = BeautyMirrorActivity.class;
    ...
    public synchronized void onDestroy() {
        ...
        if (BeautyMirrorActivity.isInstanciated()) {
            Log.w("Service is getting destroyed, finish BeautyMirrorActivity");
            BeautyMirrorActivity.instance().finish();
        }
