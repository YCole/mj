...
import static com.gome.beautymirror.fragments.FragmentsAvailable.CHAT_LIST;
...
public class ChatListFragment extends Fragment implements ContactsUpdatedListener, ChatRoomViewHolder.ClickListener, SelectableHelper.DeleteListener {
    ...
    public View onCreateView(final LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mNewDiscussionButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                BeautyMirrorActivity.instance().goToChatCreator(null, null, null, false, null);
            }
        });
    ...
    public void onItemClicked(int position) {
        if (mChatRoomsAdapter.isEditionEnabled()) {
            ...
            BeautyMirrorActivity.instance().goToChat(room.getPeerAddress().asString(), null);
        }
    }
    ...
    public void displayFirstChat() {
        ...
        if (adapter != null && adapter.getItemCount() > 0) {
            ...
            BeautyMirrorActivity.instance().goToChat(room.getPeerAddress().asStringUriOnly(), null);
        } else {
    ...
    public void onResume() {
        ...
        if (BeautyMirrorActivity.isInstanciated()) {
            BeautyMirrorActivity.instance().selectMenu(FragmentsAvailable.CHAT_LIST);
    ...
    public void onContactsUpdated() {
        if (!BeautyMirrorActivity.isInstanciated() || BeautyMirrorActivity.instance().getCurrentFragment() != CHAT_LIST)
            return;
