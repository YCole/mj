...
public class AccountPreferencesFragment extends PreferencesListFragment implements AccountCreatorListener {
    ...
    private void initAccountPreferencesFields(PreferenceScreen parent) {
        ...
        delete.setOnPreferenceClickListener(new OnPreferenceClickListener() {
            public boolean onPreferenceClick(Preference preference) {
                ...
                BeautyMirrorActivity.instance().refreshAccounts();
                return true;
            }
        });
    }
    ...
    public void onResume() {
        ...
        if (BeautyMirrorActivity.isInstanciated()) {
            BeautyMirrorActivity.instance().selectMenu(FragmentsAvailable.SETTINGS);
        }
    }
    ...
    public void onPause() {
        ...
        if (BeautyMirrorActivity.isInstanciated()) {
            ...
            BeautyMirrorActivity.instance().isNewProxyConfig();
    ...
    public void onUpdateAccount(AccountCreator accountCreator, AccountCreator.Status status, String resp) {
        ...
        if (status.equals(AccountCreator.Status.RequestOk)) {
            ...
            LinphoneUtils.displayErrorAlert(getString(R.string.pref_password_changed), BeautyMirrorActivity.instance());
        } else {
            LinphoneUtils.displayErrorAlert(LinphoneUtils.errorForStatus(status), BeautyMirrorActivity.instance());
        }
    }
