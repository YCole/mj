...
import com.gome.beautymirror.ui.LedPreference;
import com.gome.beautymirror.ui.PreferencesListFragment;
...
public class SettingsFragment extends PreferencesListFragment {
    ...
    private void initSettings() {
        ...
        findPreference(getString(R.string.pref_add_account_key)).setOnPreferenceClickListener(new OnPreferenceClickListener() {
            ...
            public boolean onPreferenceClick(Preference preference) {
                ...
                BeautyMirrorActivity.instance().displayAccountSettings(nbAccounts);
                return true;
            }
        });
    }
        ...
        if (!getResources().getBoolean(R.bool.hide_accounts)) {
            ...
            for (int i = 0; i < nbAccounts; i++) {
                ...
                account.setOnPreferenceClickListener(new OnPreferenceClickListener() {
                    public boolean onPreferenceClick(Preference preference) {
                        BeautyMirrorActivity.instance().displayAccountSettings(accountId);
                        return false;
                    }
                });
            ...
            public boolean onPreferenceClick(Preference preference) {
                synchronized (SettingsFragment.this) {
                    ...
                    if (recordAudio == PackageManager.PERMISSION_GRANTED) {
                        ...
                        BeautyMirrorActivity.instance().checkAndRequestRecordAudioPermissionForEchoCanceller();
                    }
                }
                return true;
            }
            ...
            public boolean onPreferenceClick(Preference preference) {
                synchronized (SettingsFragment.this) {
                    ...
                    if (recordAudio == PackageManager.PERMISSION_GRANTED) {
                        ...
                        BeautyMirrorActivity.instance().checkAndRequestRecordAudioPermissionsForEchoTester();
                    }
                }
                return true;
            }
    ...
    private void setVideoPreferencesListener() {
        ...
        findPreference(getString(R.string.pref_overlay_key)).setOnPreferenceChangeListener(new OnPreferenceChangeListener() {
            ...
            public boolean onPreferenceChange(Preference preference, Object newValue) {
                boolean enable = (Boolean) newValue;
                if (enable) {
                    if (BeautyMirrorActivity.instance().checkAndRequestOverlayPermission()) {
            ...
            public boolean onPreferenceChange(Preference preference, Object newValue) {
                ...
                if (use) {
                    ...
                    if (readExternalStorage == PackageManager.PERMISSION_GRANTED) {
                        ...
                        BeautyMirrorActivity.instance().checkAndRequestReadExternalStoragePermissionForDeviceRingtone();
                    }
                } else {
    ...
    private void setEncryptionZrtp() {
        LinphoneUtils.displayErrorAlert(getString(R.string.lime_encryption_enable_zrtp), BeautyMirrorActivity.instance());
    ...
    public void onResume() {
        ...
        if (BeautyMirrorActivity.isInstanciated()) {
            BeautyMirrorActivity.instance().selectMenu(com.gome.beautymirror.fragments.FragmentsAvailable.SETTINGS);
        }
    }

    @Override
    public void onPause() {
        if (BeautyMirrorActivity.isInstanciated() && LinphoneManager.isInstanciated()) {
            if (LinphoneManager.getInstance().getEchoTesterStatus())
                stopEchoTester();
            BeautyMirrorActivity.instance().hideTopBar();
        }
        super.onPause();
    }
}
