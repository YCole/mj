...
/*
BeautyMirrorGenericActivity.java
...
public class BeautyMirrorGenericActivity extends FragmentActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (!LinphoneManager.isInstanciated()) {
            finish();
            startActivity(getIntent().setClass(this, BeautyMirrorLauncherActivity.class));
            return;
        }
    }
}
