...
/*
BeautyMirrorLauncherActivity.java
...
import com.gome.beautymirror.assistant.RemoteProvisioningActivity;
 ...
 */
public class BeautyMirrorLauncherActivity extends Activity {

    private final String ACTION_CALL_LINPHONE = "com.gome.beautymirror.intent.action.CallLaunched";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Hack to avoid to draw twice BeautyMirrorActivity on tablets
    ...
    protected void onServiceReady() {
        ...
        if (getResources().getBoolean(R.bool.display_sms_remote_provisioning_activity) && LinphonePreferences.instance().isFirstRemoteProvisioning()) {
            ...
            classToStart = BeautyMirrorActivity.class;
        }
        ...
        mHandler.post(new Runnable() {
            @Override
            public void run() {
                Intent newIntent = new Intent(BeautyMirrorLauncherActivity.this, classToStart);
                Intent intent = getIntent();
                ...
                if (classToStart == BeautyMirrorActivity.class && BeautyMirrorActivity.isInstanciated() && (stringFileShared != null || fileUri != null)) {
                    if (stringFileShared != null) {
                        BeautyMirrorActivity.instance().displayChat(null, stringFileShared, null);
                    } else if (fileUri != null) {
                        BeautyMirrorActivity.instance().displayChat(null, null, stringUriFileShared);
                    }
                }
                finish();
            }
