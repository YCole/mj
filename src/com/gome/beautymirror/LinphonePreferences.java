...
import com.gome.beautymirror.purchase.Purchasable;
...
public class LinphonePreferences {
    ...
    private String getString(int key) {
        if (mContext == null && com.gome.beautymirror.LinphoneManager.isInstanciated()) {
            mContext = com.gome.beautymirror.LinphoneManager.getInstance().getContext();
        }
    ...
    public Config getConfig() {
        ...
        if (!com.gome.beautymirror.LinphoneManager.isInstanciated()) {
            ...
            return Factory.instance().createConfig(com.gome.beautymirror.LinphoneManager.getInstance().mConfigFile);
        }
        return null;
    }
    ...
    private void setAccountPassword(int n, String password, String ha1) {
        ...
        if (user != null && domain != null) {
            if (com.gome.beautymirror.LinphoneManager.getLc().getAuthInfoList().length > n && com.gome.beautymirror.LinphoneManager.getLc().getAuthInfoList()[n] != null) {
                userid = getAccountUserId(n);
                realm = getAccountRealm(n);
                com.gome.beautymirror.LinphoneManager.getLc().removeAuthInfo(com.gome.beautymirror.LinphoneManager.getLc().getAuthInfoList()[n]);
            }
            AuthInfo authInfo = Factory.instance().createAuthInfo(
                    user, userid, password, ha1, realm, domain);
            com.gome.beautymirror.LinphoneManager.getLc().addAuthInfo(authInfo);
        }
    }
    ...
    public void setAccountEnabled(int n, boolean enabled) {
        ...
        ProxyConfig prxCfg = getProxyConfig(n);
        if (prxCfg == null) {
            com.gome.beautymirror.LinphoneUtils.displayErrorAlert(getString(R.string.error), mContext);
            return;
        }
        prxCfg.edit();
...
// End of call settings
    ...
    public void setDebugEnabled(boolean enabled) {
        ...
        com.gome.beautymirror.LinphoneUtils.initLoggingService(enabled, mContext.getString(R.string.app_name));
    }
    ...
    public void setJavaLogger(boolean enabled) {
        ...
        com.gome.beautymirror.LinphoneUtils.initLoggingService(isDebugEnabled(), mContext.getString(R.string.app_name));
    }
    ...
    public void setTunnelHost(String host) {
        ...
        if (config != null) {
            config.setHost(host);
            com.gome.beautymirror.LinphoneManager.getInstance().initTunnelFromConf();
        }
    }
    ...
    public String getActivityToLaunchOnIncomingReceived() {
        return getConfig().getString("app", "incoming_call_activity", "com.gome.beautymirror.activities.BeautyMirrorActivity");
    }
