...
public class SelectableHelper {
    ...
    private com.gome.beautymirror.ui.SelectableAdapter<RecyclerView.ViewHolder> mAdapter;
    ...
    public SelectableHelper(View view, DeleteListener listener) {
        ...
        mDeleteSelectionButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                final Dialog dialog = BeautyMirrorActivity.instance().displayDialog(mContext.getString(mDialogDeleteMessageResourceId));
    ...
    public void setAdapter(com.gome.beautymirror.ui.SelectableAdapter adapter) {
        mAdapter = adapter;
    }
