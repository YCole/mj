...
public class FilletImageView extends ImageView {
    ...
    public FilletImageView(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray ta = context.obtainStyledAttributes(attrs, R.styleable.FilletImageViewRatio);
        ratio = ta.getFloat(R.styleable.FilletImageViewRatio_ratio, 0);
        mBorderRadius = ta.getInteger(R.styleable.FilletImageViewRatio_angle, 30);
        imgType = ta.getBoolean(R.styleable.FilletImageViewRatio_isCircle, false);
