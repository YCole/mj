package com.gome.beautymirror.assistant;
/*
...
public class AssistantActivity extends Activity implements OnClickListener, ActivityCompat.OnRequestPermissionsResultCallback, AccountCreatorListener {
        ...
        if (getIntent().getBooleanExtra("LinkPhoneNumber", false)) {
            ...
            if (findViewById(R.id.fragment_container) != null) {
                if (savedInstanceState == null) {
                    display(AssistantFragmentsEnum.LOGIN);
                } else {
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.assistant_cancel) {
            ...
            if (getResources().getBoolean(R.bool.assistant_cancel_move_to_back)) {
                ...
                if (firstLaunch) startActivity(new Intent().setClass(this, BeautyMirrorActivity.class));
                finish();
            }
    ...
    private void goToBeautyMirrorActivity() {
        mPrefs.firstLaunchSuccessful();
        startActivity(new Intent().setClass(this, BeautyMirrorActivity.class).putExtra("isNewProxyConfig", true));
        finish();
    }
    ...
    public void restartApplication() {
        ...
        Intent mStartActivity = new Intent(this, BeautyMirrorLauncherActivity.class);
