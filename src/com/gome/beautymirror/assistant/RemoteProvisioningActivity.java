...
public class RemoteProvisioningActivity extends Activity {
    ...
    private void goToBeautyMirrorActivity() {
        if (LinphoneService.isReady()) {
            LinphoneService.instance().setActivityToLaunchOnIncomingReceived("com.gome.beautymirror.activities.BeautyMirrorLauncherActivity");
            //finish(); // To prevent the user to come back to this page using back button
            startActivity(new Intent().setClass(this, BeautyMirrorLauncherActivity.class));
        } else {
            finish();
        }
    }
