...
public class LinphoneContact implements Serializable, Comparable<LinphoneContact> {
    ...
    //ACCOUNT  NAME ICON TIME DEVICES
    ...
    private List<com.gome.beautymirror.contacts.LinphoneNumberOrAddress> addresses;
    ...
    public void addNumberOrAddress(com.gome.beautymirror.contacts.LinphoneNumberOrAddress noa) {
        if (noa == null) return;
        if (noa.isSIPAddress()) {
            hasSipAddress = true;
            addresses.add(noa);
            ...
            for (com.gome.beautymirror.contacts.LinphoneNumberOrAddress number : addresses) {
    ...
    public List<com.gome.beautymirror.contacts.LinphoneNumberOrAddress> getNumbersOrAddresses() {
        return addresses;
    }

    public boolean hasAddress(String address) {
        for (com.gome.beautymirror.contacts.LinphoneNumberOrAddress noa : getNumbersOrAddresses()) {
            if (noa.isSIPAddress()) {
    ...
    public void removeNumberOrAddress(com.gome.beautymirror.contacts.LinphoneNumberOrAddress noa) {
        if (noa != null && noa.getOldValue() != null) {
            ...
            if (isFriend()) {
                ...
                com.gome.beautymirror.contacts.LinphoneNumberOrAddress toRemove = null;
                for (com.gome.beautymirror.contacts.LinphoneNumberOrAddress address : addresses) {
    ...
    public void addOrUpdateNumberOrAddress(com.gome.beautymirror.contacts.LinphoneNumberOrAddress noa) {
                    ...
                    if (noa.isSIPAddress() && LinphoneManager.getInstance().getContext().getResources().getBoolean(R.bool.use_linphone_tag)) {
                        if (androidTagId != null) {
                            addChangesToCommit(ContentProviderOperation.newInsert(ContactsContract.Data.CONTENT_URI)
                                    ...
                                    .withValue(ContactsContract.Data.MIMETYPE, com.gome.beautymirror.contacts.ContactsManager.getInstance().getString(R.string.sync_mimetype))
                                    .withValue(ContactsContract.Data.DATA1, noa.getValue())
                                    .withValue(ContactsContract.Data.DATA2, com.gome.beautymirror.contacts.ContactsManager.getInstance().getString(R.string.app_name))
                        ...
                        if (noa.isSIPAddress()) {
                            ...
                            values.put(CommonDataKinds.SipAddress.LABEL, com.gome.beautymirror.contacts.ContactsManager.getInstance().getString(R.string.addressbook_label));
                        } else {
                            values.put(ContactsContract.Data.MIMETYPE, ContactsContract.CommonDataKinds.Phone.CONTENT_ITEM_TYPE);
                            values.put(ContactsContract.CommonDataKinds.Phone.NUMBER, noa.getValue());
                            values.put(ContactsContract.CommonDataKinds.Phone.TYPE, ContactsContract.CommonDataKinds.Phone.TYPE_CUSTOM);
                            values.put(ContactsContract.CommonDataKinds.Phone.LABEL, com.gome.beautymirror.contacts.ContactsManager.getInstance().getString(R.string.addressbook_label));
                        }
                        if (androidRawId != null) {
                            addChangesToCommit(ContentProviderOperation.newInsert(ContactsContract.Data.CONTENT_URI)
                                    .withValue(ContactsContract.Data.RAW_CONTACT_ID, androidRawId)
    ...
    private void createOrUpdateFriend() {
        ...
        if (isFriend()) {
            ...
            for (com.gome.beautymirror.contacts.LinphoneNumberOrAddress noa : addresses) {
                if (noa.isSIPAddress()) {
        ...
        if (!com.gome.beautymirror.contacts.ContactsManager.getInstance().hasContactsAccess()) {
            ...
            com.gome.beautymirror.contacts.ContactsManager.getInstance().fetchContactsAsync();
        }
    }

    public void delete() {
        if (isAndroidContact()) {
            com.gome.beautymirror.contacts.ContactsManager.getInstance().delete(getAndroidId());
        }
        if (isFriend()) {
            deleteFriend();
        }
    ...
    public void refresh() {
        ...
        if (isAndroidContact()) {
            ...
            getAndroidIds();
            hasSipAddress = false;
            for (com.gome.beautymirror.contacts.LinphoneNumberOrAddress noa : getAddressesAndNumbersForAndroidContact()) {
                addNumberOrAddress(noa);
            }
        } else if (isFriend()) {
            fullName = "99999";//friend.getName();
            ...
            if (lc != null && lc.vcardSupported()) {
                for (Address addr : friend.getAddresses()) {
                    if (addr != null) {
                        addNumberOrAddress(new com.gome.beautymirror.contacts.LinphoneNumberOrAddress(addr.asStringUriOnly(), true));
                    }
                }
                for (String tel : friend.getPhoneNumbers()) {
                    if (tel != null) {
                        addNumberOrAddress(new com.gome.beautymirror.contacts.LinphoneNumberOrAddress(tel, false));
                    }
                }
            } else {
    ...
    private List<com.gome.beautymirror.contacts.LinphoneNumberOrAddress> getAddressesAndNumbersForAndroidContact() {
        List<com.gome.beautymirror.contacts.LinphoneNumberOrAddress> result = new ArrayList<>();
        ContentResolver resolver = LinphoneService.instance().getContentResolver();
        ...
        Cursor c = resolver.query(ContactsContract.Data.CONTENT_URI, projection, select, new String[]{getAndroidId(), ContactsContract.CommonDataKinds.SipAddress.CONTENT_ITEM_TYPE, ContactsContract.CommonDataKinds.Phone.CONTENT_ITEM_TYPE, com.gome.beautymirror.contacts.ContactsManager.getInstance().getString(R.string.sync_mimetype)}, null);
        if (c != null) {
            while (c.moveToNext()) {
                String mime = c.getString(c.getColumnIndex(ContactsContract.Data.MIMETYPE));
                if (mime != null && mime.length() > 0) {
                    if (mime.equals(ContactsContract.CommonDataKinds.SipAddress.CONTENT_ITEM_TYPE) || mime.equals(com.gome.beautymirror.contacts.ContactsManager.getInstance().getString(R.string.sync_mimetype))) {
                        String number = c.getString(c.getColumnIndex("data1")); // SIP_ADDRESS
                        result.add(new com.gome.beautymirror.contacts.LinphoneNumberOrAddress(number, true));
                        ...
                        result.add(new com.gome.beautymirror.contacts.LinphoneNumberOrAddress(number, normalized_number));
                    }
                }
            }
            c.close();
    ...
    private String findLinphoneRawContactId() {
        ...
        Cursor c = resolver.query(ContactsContract.RawContacts.CONTENT_URI, projection, selection, new String[]{getAndroidId(), com.gome.beautymirror.contacts.ContactsManager.getInstance().getString(R.string.sync_account_type)}, null);
        if (c != null) {
            if (c.moveToFirst()) {
                result = c.getString(c.getColumnIndex(ContactsContract.RawContacts._ID));
            }
    ...
    private void createLinphoneContactTag() {
        ...
        batch.add(ContentProviderOperation.newInsert(ContactsContract.RawContacts.CONTENT_URI)
                .withValue(ContactsContract.RawContacts.ACCOUNT_TYPE, com.gome.beautymirror.contacts.ContactsManager.getInstance().getString(R.string.sync_account_type))
                .withValue(ContactsContract.RawContacts.ACCOUNT_NAME, com.gome.beautymirror.contacts.ContactsManager.getInstance().getString(R.string.sync_account_name))
                .withValue(ContactsContract.RawContacts.AGGREGATION_MODE, ContactsContract.RawContacts.AGGREGATION_MODE_DEFAULT)
                .build());
