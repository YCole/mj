...
**/
LINPHONE_PUBLIC void linphone_core_set_call_logs_database_file(LinphoneCore *lc, const char *path);
 ...
 * @param device
**/
LINPHONE_PUBLIC void linphone_core_set_call_logs_friend(LinphoneCore *lc, const char *account, const char *device);
