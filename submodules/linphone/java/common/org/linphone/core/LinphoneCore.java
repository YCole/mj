...
public interface LinphoneCore {
	...
	**/
	...
	/**
	 * Sets the path to the database where the logs will be stored (if enabled) for beautymirror
	 * @param path the database where the logs will be stored.
	 */
	public void setCallLogsDatabaseFile(String path);

	/**
	 * Sets the account and device for friend where the logs will be stored (if enabled)
	 * @param path the database where the logs will be stored.
	 */
